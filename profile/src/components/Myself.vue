...
// Recibimos el idioma actual desde el componente principal
defineProps<{
  currentLang: 'ES' | 'EN'
}>();

// Diccionario de textos para la sección "Sobre mí"
const texts = {
  ES: {
...
<style scoped>
/* Importamos una fuente monoespaciada para el look Pokedex si no está global */
